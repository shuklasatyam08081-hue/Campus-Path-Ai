      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-8 mb-16">
          <div className="space-y-6">
            <div className="p-6 bg-[#0d1117] border border-[#30363d] rounded-2xl relative overflow-hidden group">
            ...
            <div className="p-6 bg-[#161b22]/50 border border-[#30363d] rounded-2xl">
