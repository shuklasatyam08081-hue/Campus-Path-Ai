...
export default function Register() {
  ...
  return (
    <div style={{ 
      ...
      {/* Background blocks removed for clean look like Login/Contact */}
      <div style={{ width: '100%', maxWidth: '480px', position: 'relative', zIndex: 1 }}>
        ...
        <div className="glass-card" style={{ 
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.85rem', fontWeight: 700, color: 'var(--text-secondary)', marginLeft: '0.5rem' }}>Full name</label>
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', lineHeight: 1.6, padding: '0 0.5rem' }}>
              By creating an account, you agree to our <span style={{ color: 'var(--accent-purple)', cursor: 'pointer' }}>Terms of Service</span> and <span style={{ color: 'var(--accent-purple)', cursor: 'pointer' }}>Privacy Policy</span>.
            </p>
            ...
            <button 
              ...
              disabled={loading} 
              style={{ 
                width: '100%', justifyContent: 'center', padding: '1.1rem', marginTop: '0.5rem', 
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
          ...
          <Link to="/login" style={{ color: 'var(--accent-purple)', fontWeight: 700, textDecoration: 'none' }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
